...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">Gifts Sent</h2>
...
@section('js')
<script>
    const sweetalert_title = "Do you want to delete Sent Gift";
    ...
    <script src="{{URL::asset('assets/js/custom/giftsSent.js')}}"></script>
@endsection
