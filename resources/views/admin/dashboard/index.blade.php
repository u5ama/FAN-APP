    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class=""><p class="mb-3 tx-14 text-white">Players</p></div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class=""><p class="tx-20 font-weight-bold mb-1 text-white">{{$players}}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class=""><p class="mb-3 tx-14 text-white">Fans</p>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class=""><p class="tx-20 font-weight-bold mb-1 text-white">{{$fans}}</p></div>
                        </div>
                    </div>
                </div>
