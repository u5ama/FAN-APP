...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">Edit Gift</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        @csrf
                        <input type="hidden" id="edit_value" name="edit_value" value="{{ $gift->id }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify"
                                           name="image"
                                           data-default-file="{{url($gift->image)}}"
                                           id="image" required/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
