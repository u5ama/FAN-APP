...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">Teams</h2>

            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('admin.teams.create') }}" class="btn btn-primary  mr-2">
...
@section('js')
<script>
    const sweetalert_title = "Do you want to delete Team";
    ...
    <script src="{{URL::asset('assets/js/custom/teams.js')}}"></script>
@endsection
