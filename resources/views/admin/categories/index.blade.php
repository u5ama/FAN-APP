...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">Schools</h2>

            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('admin.schools.create') }}" class="btn btn-primary  mr-2">
...
@section('js')
<script>
    const sweetalert_title = "Do you want to delete Category";
    ...
    <script src="{{URL::asset('assets/js/custom/categories.js')}}"></script>
@endsection
