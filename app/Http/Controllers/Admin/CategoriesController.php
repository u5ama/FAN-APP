...
//                })
                ->addColumn('action', function($categories){
                    $edit_button = '<a href="' . route('admin.schools.edit', [$categories->id]) . '" class="btn btn-info btn-icon" data-toggle="tooltip" data-placement="top" title="' . config('languageString.edit') . '"><i class="bx bx-pencil font-size-16 align-middle"></i></a>';
