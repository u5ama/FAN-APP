...
Route::group(['middleware' => ['auth:admin', 'adminLanguage']], function () {
    ...
    // Admin Panel Players Resource
    Route::resource('players', 'PlayerController');

    // Admin Panel Company Status Get Method
    Route::get('getPlayersStatus/{company_id}', 'CompanyController@getCompanyStatus')->name('getPlayersStatus');

    // Admin Panel Company Status Change Method
    Route::get('player/{id}/{status}', 'CompanyController@status')->name('playerStatus');

    Route::resource('schools', 'CategoriesController');
    ...
    Route::resource('recommendations', 'ReportProblemController');

//    Route::get('recommendations', 'ReportProblemController@index')->name('recommendations');
